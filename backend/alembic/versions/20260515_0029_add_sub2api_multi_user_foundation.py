...
def upgrade() -> None:
    ...
    _preflight(bind, tables, default_owner)
...
def _preflight(bind, tables: set[str], default_owner: str) -> None:
    legacy_rows = 0
    ...
    if default_owner and not default_owner.startswith("sub2api:"):
